...
# ── Config ────────────────────────────────────────────────────────────────────
CSV_PATH = "data/results/coffee_ratings_yscore.csv"  # reads scored CSV output from analyse_coffee.py
OUTPUT_PATH = "data/results/chart1_scatter.png"
...
# ══════════════════════════════════════════════════════════════════════════════
OUTPUT_PATH_2 = "data/results/chart2_processing.png"
...
# ══════════════════════════════════════════════════════════════════════════════
OUTPUT_PATH_3 = "data/results/chart3_radar.png"
