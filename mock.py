...
# Show the top 10 largest values to ensure outliers are handled
print("\nTop 10 Largest Altitudes (Metres):")
print(raw_data['altitude_clean_metres'].sort_values(ascending=False).head(10))

# show the original value at indicies where the cleaned value is above 2570m
print("\nOriginal Altitude Values for Cleaned Altitudes Above 2570m:")
print(raw_data.loc[raw_data['altitude_clean_metres'] > 2570, 'altitude'])
